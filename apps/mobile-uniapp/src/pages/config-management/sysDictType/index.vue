    ...
    <view class="list">
      ...
      <view v-else class="list-item" v-for="item in list" :key="item.id">
        <view class="item-content">
          <text class="item-name">{{ item.dictName }}</text>
          <text class="item-type">{{ item.dictType }}</text>
          <text class="item-desc" v-if="item.remark">{{ item.remark }}</text>
        </view>
...
import { query } from '@/api/sysDictType';
